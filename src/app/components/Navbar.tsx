...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="flex items-center p-3 bg-white border-b border-gray-300 font-sans">
      {/* โลโก้ */}
      ...
      <ul className="flex space-x-6 justify-start flex-grow">
        <li>
          <Link
            ...
            className={`px-4 py-3 rounded-lg ${
              pathname === '/' ? 'bg-blue-100 text-blue-500' : 'text-gray-500'
            } font-bold text-sm`}
          >
            เพิ่มข้อมูล
          </Link>
        ...
        <li>
          <Link
            href="/User-info"
            className={`px-4 py-3 rounded-lg ${
              pathname === '/view-data' ? 'bg-blue-100 text-blue-500' : 'text-gray-500'
            } font-bold text-sm`}
          >
            ข้อมูลผู้ใช้
          </Link>
